  ...
  <div class="app-index-3">
    <div class="gameList">
      ...
      <div class="title_zh" style="display:flex;justify-content:center;align-items:center;">
        <span class="title_top">推荐游戏</span>
      </div>
      <van-swipe :autoplay="4000" class="banner">
        <van-swipe-item v-for="(item, index) in gameList" :key="index">
          <ul>
            <li v-for="(item1,index1) in item"  @click="$playGame(item1.temp,item1.text)" :class="{'gray-scal':$getGameStatus(item1.temp,item1.text)}">
              <p class="title_desc">
                {{ item1.title }}
              ...
              <van-image lazy-load :src="item1.pic"/>
            </li>
          </ul>
        </van-swipe-item>
      </van-swipe>
    ...
    <div class="groupInfo">
      ...
      <div class="title_zh" style="display:flex;justify-content:center;align-items:center;">
        <span class="title_top">集团资讯</span>
      </div>
      <div class="groupInfoContent">
        ...
        <swiper v-if="groupImgList.length>1" :height="250" :options="swiperOption" class="swiper-container swiper_h5">
    ...
    <div class="buss">
      ...
      <div class="title_zh" style="display:flex;justify-content:center;align-items:center;">
        <span class="title_top">集团业务</span>
      </div>
      <div class="list">
        <div class="list_item" v-for="(item,index) in navList_new" :key="index">
          <div class="item_box">
            ...
            <p class="groupBuss_item_title">{{item.title}}</p>
          </div>
        </div>
      </div>
    </div>
    <div class="link" >
        <ul>
            <!-- <li @click="go('/')">代理合作</li>
            <li @click="go('/')">新手教程</li>
            <li @click="go('/')">进入网页版</li> -->
            <router-link :to="{ path: '/agentHomepage' }" tag="li">代理合作</router-link>
            <router-link :to="{ path: '/help/tutorial' }" tag="li">新手教程</router-link>
            <li @click="goWebPage">进入网页版</li>
        </ul>
    </div>
    ...
    return {
      ...
      gameList: [
        [
          ...
          {
            title: "VR彩票",
            second_title: "多台摄像实时直播<br>公平诚信首选平台",
            path: "/chess",
          ...
          {
            title: "PT电子",
            second_title: "超多精品游戏<br>亿万奖池爆不停",
            path: "/real",
          ...
          {
            title: "CQ9电子",
            second_title: "最热门的电子游艺<br>无比流畅的体验",
            path: "/lottery",
          ...
          {
            title: "MG电子",
            second_title: "巨额累计奖池<br>经典游戏玩不腻",
            path: "/fish",
        ...
        [
          {
            title: "开元棋牌",
            second_title: "与人斗，其乐无穷<br>首家对战类棋牌",
            path: "/fish",
          ...
          {
            title: "GG棋牌",
            second_title: "经典德普&奥马哈<br>亮出你的皇家同花顺",
            path: "/fish",
          ...
          {
            title: "沙巴体育",
            second_title: "最全体育赛事<br>超过70+盘口玩法",
            path: "/fish",
          ...
          {
            title: "IM电竞",
            second_title: "实时赛事直播<br>专业战队数据分析",
            path: "/fish",
...
.app-index-3 {
  .title {
    ...
    .line {
      width: 100px;
      height: 4px;
      background: linear-gradient(to right, rgba(0, 0, 0, 0), #FEE42B);
      border-radius: 6px;
      &:last-child {
        background: linear-gradient(to right, #FEE42B, rgba(0, 0, 0, 0));
      }
    }
    .title_top {
      font-size: 24px;
