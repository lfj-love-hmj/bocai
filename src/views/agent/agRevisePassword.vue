    ...
    <div class="main">
      <div class="reseter">
        <div class="reset">
          <div>
            <p>旧密码：</p>
            <input type="password" v-model="list.old_password" placeholder="请输入旧密码">
          </div>
        </div>
        <div class="reset">
          <div >
            <p>新密码：</p>
             <input type="password" v-model="list.password" placeholder="请输入6~12位字符">
          </div>
        </div>
        <div class="reset">
          <div>
            <p>确定密码：</p>
            <input type="password" v-model="list.repassword" placeholder="请再次输入密码">
          </div>
        </div>
      </div>
