...
<template>
    <div class="container">
        ...
        <div class="main">
            ...
            <div class="domain">
                <!-- 用户信息 -->
                <div class="user" :style="{backgroundImage:`url(${require('@assets/img3_0/agent/agent_bg_info@2x.png')})`}">
                    <div class="top">
                        <div class="left">
                            <div class="name">
                                本月有效投注
                ...
                <div class="list" v-if="agent_domain.length>0" v-for="(item, index) in agent_domain" :key="index">
                    ...
                    <img class="qrData" @click="clickDomain(item)" :src="require('@assets/img3_0/agent/home/agentqrcode.png')" alt="">
                </div>
            ...
            <div class="aagames-button-box">
                <button type="button" class="aagames-button login-out dark" @click="signOut">退出登录</button>
            </div>
        </div>
