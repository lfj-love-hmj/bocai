<template>
  <div class="accountSafe-page">
    ...
    <div class="reset">
      ...
      <div class="aagames-select-box">
        <div class="select">
          <img src="@assets/img3_0/personalData/user.png" />
          <span>昵称</span>
          <input
            type="text"
            placeholder="您未填写昵称，立即填写"
      ...
      <div class="aagames-select-box">
        <div class="select">
          ...
          <input
            ...
            placeholder="请输入与银行卡一致的真实姓名"
            @focus="isShowSave = true"
            v-model="list.realname"
          />
        </div>
      </div>
      <!-- <div v-show="['wanqu'].includes($projectname)" class="aagames-select-box"> -->
      <div class="aagames-select-box">
        <div class="select">
          <img :src="$imgs['personalData/birthday']" />
          <span>出生日期</span>
          <input
            type="text"
            placeholder="请输入出生日期"
      ...
      <div class="aagames-select-box">
        <div class="select">
          <img src="@assets/img3_0/personalData/wechat.png" />
          <span>微信号</span>
          <input
            type="text"
            placeholder="您未填写微信，立即填写"
            @focus="isShowSave = true"
            v-model="list.wechat"
          />
        </div>
      ...
      <div class="aagames-select-box">
        <div class="select">
          <img src="@assets/img3_0/personalData/qq.png" />
          <span>QQ 号</span>
          <input type="text" placeholder="您未填写QQ，立即填写" @focus="isShowSave = true" v-model="list.qq" />
        </div>
      </div>
      <div class="aagames-select-box">
        <div class="personal-title">账户绑定</div>
      </div>
      <div class="aagames-select-box">
        <div class="select">
          <img src="@assets/img3_0/personalData/shouji.png" />
          <span>手机号</span>
          <input
            type="text"
            placeholder="立即绑定"
      ...
      <div class="aagames-select-box">
        <div class="select">
          <img src="@assets/img3_0/personalData/mail.png" />
          <span>邮箱地址</span>
          <input
            type="text"
            placeholder="立即绑定"
      ...
      <div class="aagames-select-box">
        <div class="personal-title">安全设置</div>
      </div>
      <div class="aagames-select-box">
        <div class="select">
          <img src="@assets/img3_0/personalData/pass.png" />
          <span>登录密码</span>
      ...
      <div class="aagames-select-box" @click="open(2)">
        <div class="select">
          <img src="@assets/img3_0/personalData/zjmm.png" />
          <span>资金密码</span>
          <span
            :class="['input-tips',{'red':password == 1}]"
          >{{password == 1? '您未设置资金密码': '已设置资金密码'}}</span>
          <van-icon name="arrow" />
        </div>
      </div>
      <div class="aagames-select-box mb40" @click="open(3)">
        <div class="select">
          <img src="@assets/img3_0/personalData/mbwt.png" />
          <span>密保问题</span>
          <span
            :class="['input-tips',{'red':answer === 1}]"
          >{{answer === 1 ? '您未设置密保问题': '已设置密保问题'}}</span>
          <van-icon name="arrow" />
        </div>
      </div>
      <div v-show="isShowSave" class="aagames-button-box">
        <button class="aagames-button" type="button" @click="submit">保存</button>
      </div>
    </div>
    <van-popup v-model="showDate" position="bottom">
      <template v-if="$projectname==='10057'">
        <van-datetime-picker
            type="date"
            title="请选择出生日期"
