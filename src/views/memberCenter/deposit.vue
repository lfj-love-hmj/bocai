    ...
    <div class="m-body">
            ...
            <div class="board">
              ...
              <div class="list-cells">
                <div class="cell" @click="showPayments">
                  ...
                  <div class="cell-body">
                    {{ payment && (payment.alias || payment.name) || '请选择存款渠道' }}
                    <span v-if="payment && payment.act_text" class="cell-tip">{{payment.act_text}}</span>
        ...
        <div class="pop-body payStatus">
          ...
          <div class="btn">
            <div class="aagames-button-box fail-button">
              ...
              <button class="aagames-button" type="button" @click="paymentFail = false">确认</button>
            </div>
      ...
      >
        ...
        <div class="pop-body payStatus">
          ...
          <div class="btn">
            <div class="aagames-button-box">
              <button class="aagames-button" type="button" @click="handleSuccess">确认</button>
            </div>
          </div>
        </div>
      </van-popup>
