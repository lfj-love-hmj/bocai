        ...
        <div class="brand-block">
          ...
          <div class="brand-block-inner">
            <video style="width: 100%" controls :poster="$imgs['brand/p2/video-img-5']">
              <source src="https://wq-app.oss-accelerate.aliyuncs.com/app/cPzJHbzpntCjFM6SHqU9e2dhzteyVsogfDQzlWX4.mp4">
            </video>
          </div>
        </div>
        <div class="brand-block">
              ...
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <div class="brand-video">
                    <div class="brand-video-item">
                      <div class="">
                        <video style="width: 100%" controls :poster="$imgs['brand/p2/video-img-1']">
                          <source src="https://wq-app.oss-accelerate.aliyuncs.com/app/3yrvq53qmZllV2Ck7TtCJVZ93zllHEglmD2Zis2v.mp4">
                        </video>
                      </div>
                      <p>巴黎圣日耳曼对阵波尔多</p>
                    </div>
                    <div class="brand-video-item">
                      <div class="">
                        <video style="width: 100%" controls :poster="$imgs['brand/p2/video-img-2']">
                          <source src="https://wq-app.oss-accelerate.aliyuncs.com/app/bPq6bzA24zLbNWMs5dDq9Ko9gxmUnS2v0tmYO1tH.mp4">
                        </video>
                      </div>
                      <p>大巴黎4：3主场胜波尔多</p>
                    </div>
                ...
                <div class="swiper-slide">
                  <div class="brand-video">
                    <div class="brand-video-item">
                      <div class="">
                        <video style="width: 100%" controls :poster="$imgs['brand/p2/video-img-3']">
                          <source src="https://wq-app.oss-accelerate.aliyuncs.com/app/AKDT5rqaBx88ED45aTzdOYZ4yGInebnesbzdalNe.mp4">
                        </video>
                      </div>
                      <p>里昂VS波尔</p>
                    </div>
                    <div class="brand-video-item">
                      <div class="">
                        <video style="width: 100%" controls :poster="$imgs['brand/p2/video-img-4']">
                          <source src="https://wq-app.oss-accelerate.aliyuncs.com/app/ymjbrRymFq3kodqPW1EK3sC0kjOqz39BwgzAqNBn.mp4">
                        </video>
                      </div>
                      <p>摩纳哥客场不敌波尔多</p>
                    </div>
            ...
            <div class="swiper-container swiper-container02">
              <div class="swiper-wrapper">
                <div class="swiper-slide" v-for="(item,index) in bannerArray">
                  <span>{{item.num}}</span>
                  <img :src="$imgs['brand/p2/player-'+(index+1)+'']" :alt="1">
                </div>
              </div>
            </div>
...
export default {
  ...
  data () {
    return {
      title: '品牌实力',
      bannerArray:[
        {num:'23',name:'洛里斯·贝尼托',eng:'Loris Benito'},
        {num:'03',name:'巴勃罗·纳西门托·卡斯特罗',eng:'Pablo Nascimento Castro'},
        {num:'01',name:'贝诺特·科斯蒂',eng:'Benoit Costi'},
        {num:'18',name:'黄义助',eng:'Ui Jo Hwang'},
        {num:'06',name:'劳伦特 科斯切尔尼',eng:'Laurent Koscielny'}],
      activeIndex:0,
      name:'何塞·路易斯·帕洛米诺',
