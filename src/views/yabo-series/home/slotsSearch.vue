<template>
  <div class="slots">
    ...
    <van-sticky :offset-top="42" style="box-shadow:0px 4px 8px 0px rgba(0,0,0,0.06);background-color: #fff">
    ...
    <!-- <div class="search-info" v-if="keyword">
      <span>{{ keyword }}</span>的搜索结果 <span @click="clearSearch">清除</span>
    </div> -->
