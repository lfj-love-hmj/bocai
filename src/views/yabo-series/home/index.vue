<template>
  <div id="home">
    ...
    <div :class="[{'bg-img':['Home'].indexOf($route.name) !== -1}]" id="tab-wrap">
      ...
      <div class="xb-header" v-if="$projectname === '10027'">
        <div class="xb-header-logo" @click="openSidenav">
          <img :src="$imgs['home/bet_home_icon_list@2x']" alt="">
        </div>
        <p>西宝娱乐</p>
        <div class="xb-header-kf" @click="callService"><img :src="$imgs['home/bet_home_icon_kefu@2x']" alt=""><span>客服</span></div>
      </div>
      ...
      <!-- <tabStyle01 v-if="$projectname === '10023'||$projectname === '10024'||$projectname === '10025'||$projectname === '10026'||$projectname === '10027'||$projectname === '10028'||$projectname === '10029'||$projectname === '10033'"></tabStyle01> -->
<!--      <tabStyle01 v-if="$projectname === '10023'"></tabStyle01>-->
      <tabStyle :appInstallStatus="appInstallStatus" v-if="$projectname === '10023'||$projectname === '10024'||$projectname === '10050'||$projectname === '10050'||$projectname === '10025'||$projectname === '10026'||$projectname === '10027'||$projectname === '10028'||$projectname === '10029'||$projectname === '10033'"></tabStyle>
      <tabStyle02 v-if="$projectname === '10022'"></tabStyle02>
    ...
    <van-popup v-model="leftNav" position="left" class="leftnav">
      <div class="leftnav-logo">
        <p><img :src="$imgs['home/logo_install']" alt=""><span>西宝娱乐</span></p>
      </div>
      <div class="leftnav-con">
        <h2>西宝娱乐</h2>
        <p class="leftnav-con-item" @click="linkTo('/news')"><img :src="$imgs['home/icon_sheet_1@2x']" alt=""><span>消息中心</span></p>
        <p class="leftnav-con-item"><img :src="$imgs['home/icon_sheet_4@2x']" alt=""><span>永久域名</span><i v-clipboard:copy="`https://${$config[$projectname].domain}`" v-clipboard:success="onCopy" v-clipboard:error="onError">{{$config[$projectname].domain}}</i></p>
        <p class="leftnav-con-item" @click="linkTo('/aboutWe')"><img :src="$imgs['home/icon_sheet_5@2x']" alt=""><span>关于我们</span></p>
      </div>
      <p class="leftnav-log" v-if="!access_token" @click="linkTo('/login')"><span>立即登录</span></p>
      <p class="leftnav-log" v-else  @click="signOut"><img :src="$imgs['home/icon_sheet_out@2x']" alt=""><span class="c-999">安全退出</span></p>
    </van-popup>
  </div>
</template>
...
import tabStyle01 from './tabStyle01'
import tabStyle02 from './tabStyle02'
