  ...
  <div class="accountSafe-page">
    ...
    <div class="reset">
      ...
      <div class="aagames-select-box">
        <div class="select">
          <img :src="$imgs['personalData/user']" />
          <span>昵称</span>
          <input
            type="text"
      ...
      <div class="aagames-select-box">
        <div class="select">
          <img :src="$imgs['personalData/wechat']" />
          <span>微信号</span>
          <input
            type="text"
      ...
      <div class="aagames-select-box">
        <div class="select">
          <img :src="$imgs['personalData/shouji']" />
          <span>手机号</span>
          <input
            type="text"
            placeholder="立即绑定"
      ...
      <div class="aagames-select-box">
        <div class="select">
          <img :src="$imgs['personalData/mail']" />
          <span>邮箱地址</span>
          <input
            type="text"
            placeholder="立即绑定"
      ...
      <div class="aagames-select-box">
        <div class="select">
          <img :src="$imgs['personalData/pass']" />
          <span>登录密码</span>
      ...
      <div class="aagames-select-box" @click="open(2)">
        <div class="select">
          <img :src="$imgs['personalData/zjmm']" />
          <span>资金密码</span>
          <span
      ...
      <div class="aagames-select-box mb40" @click="tosetQues">
        <div class="select">
          <img :src="$imgs['personalData/mbwt']" />
          <span>密保问题</span>
          <span
