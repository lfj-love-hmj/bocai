<template>
  <div class="register">
      <div class=" submit-form">
        ...
        <div class="ar-check">
          <p @click="toggleCheck"><i :class="arChecked?'on':''"></i><span>同意并接受《合作代理条款》</span></p>
        </div>
        <div class="function">
          <div class="aagames-button-box">
            <button type="button" class="aagames-button" @click="register">成为代理</button>
          </div>
        </div>
        <p class="to-login">已有账号？请<router-link to="/agentAuth/login">登录</router-link></p>
      </div>
