    ...
    <div class="m-body">
      ...
      <div class="user-info">
        <div class="person-info">
          ...
          <img @click="listPath('personalData')" :src="$imgs['memberCenter/login-out']" alt="login-out" />
          <div class="right">
            <div class="top">
      ...
      <div class="balance-out">
        ...
        <div class="main-balance">
          ...
          <!--<van-icon-->
            ...
            <!--name="replay"-->
          <!--/>-->
          <img class="refresh" @click="refresh" :class="{ active: balanceLoading }" :src="$imgs['memberCenter/Refresh@2x']" alt="">
        </div>
        ...
        <template v-if='!$config[$projectname].hasXcoin'>
          <ul class="quick-link">
            ...
            <li @click="listPath('washcode')"><img :src="$imgs['memberCenter/xima@2x']" alt=""><span>洗码</span></li>
      ...
      <div :class="['person-entr',{'mb120':!isLogin}]">
        ...
        <van-row align="center" :gutter="2">
          ...
          >
            <i :class="'list' + (index + 1)" :style="{backgroundImage:$bImgs['memberCenter/list_'+(index+1)+'']}"></i>
...
export default {
  ...
  mounted() {
    if(['10027','10033'].includes(process.env.VUE_APP_PROJECT_NAME)) {
      let that = this;
      document.querySelector('.member-page').onscroll = function (){
      ...
      // document.querySelector('.member-page').addEventListener('onscroll',this.handleScroll)
      // window.ontouchmove = () => {
      //   let scrollTop = document.querySelector('.member-page').scrollTop
      //   let offsetTop = document.querySelector('#header').offsetTop
  ...
  destroyed() {
    // document.querySelector('.member-page').removeEventListener('onscroll',this.handleScroll)
  }
};
</script>
