<template>
  <div class="vip-page">
    ...
    <van-nav-bar
      ...
      v-if="$projectname!=='10023'&&$projectname!=='10033'&& !$route.query.source"
    >
    </van-nav-bar>
    <div class="m-body bg-img" :style="{paddingTop: $route.query.source && '0px !important'}">
      <Privilege v-if="$projectname!=='10023' && $projectname!=='10033'" />
      <template v-else>
        <van-sticky :container="vip-page">
          <div class="vip-tab-head">
            <van-icon name="arrow-left" @click="goback" />
            <span :class="active===0?'on':''" @click="tab(0)">VIP特权</span>
            <span :class="active===1?'on':''" @click="tab(1)">VIP详情</span>
          </div>
        </van-sticky>
