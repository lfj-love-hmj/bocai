<template>
  <div id="interestRate">
    ...
    <div class="container" :class="{ 'no-header': !isShowHeader }">
      <div class="section">
        <img class="title" src="./assets/title-1@2x.png" alt="">
      ...
      <div class="section">
        <img class="title" src="./assets/title-2@2x.png" alt="">
        <img class="step" src="./assets/step@2x.png" alt="">
        <!-- 借贷金额 -->
      ...
      <div class="section">
        <img class="title" src="./assets/title-3@2x.png" alt="">
        <!-- 活动细则 -->
        <div class="rulesActivities">
          <div class="rules">
            <p><span class="decorate">1</span> {{$config[$projectname].project}}所有二星及以上会员均可享受，每周可以参与一次。</p>
            <p>
              <span class="decorate">2</span>
              会员如果申请500元借贷，根据会员等级如果是二星会员需要存款500元，到账一共1000元。如果是钻石会员只需要存款400元，一共到账900元。
            </p>
            <p>
              <span class="decorate">3</span>
              分期天数指的如果会员选择1天内还款，系统会在申请活动的24小时后收回贷款金额。如果会员选择3天内还款，那么系统会在申请活动的每24小时收回贷款金额的1/3，分三次全额收回。
            </p>
            <p>
              <span class="decorate">4</span>会员参与活动期间无法发起提现，直到系统自动收回贷款金额或者。
            </p>
            <p>
              <span class="decorate">5</span>
              贷款期间不影响存款，但是系统还是会按照贷款金额和还款天数来计算每日还款金额并自动扣减。
            </p>
            <p>
              <span class="decorate">6</span>
              如果客户账户余额不足参与本金的5%可以去活动页面申请破产保护，即可免除一切还款。如果会员完成活动时为盈利状态，公司将抽取盈利部分的20%作为借贷佣金。
            </p>
            <p>
              <span class="decorate">7</span>
            ...
            <p><span class="decorate">8</span>{{$config[$projectname].project}}拥有最终解析权。</p>
          </div>
        </div>
      </div>
    </div>
